      ...
      <div className="container mx-auto px-4 py-12 md:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="text-center sm:text-left">
            <h2 className="text-2xl md:text-3xl font-bold text-orange-500 mb-3">FoodBox</h2>
          ...
          {/* Quick Links */}
          <div className="text-center sm:text-left">
            <h3 className="text-lg md:text-xl font-semibold mb-4 text-orange-400">Quick Links</h3>
          ...
          {/* Contact Info */}
          <div className="text-center sm:text-left">
            <h3 className="text-lg md:text-xl font-semibold mb-4 text-orange-400">Contact</h3>
            <ul className="space-y-3 md:space-y-4">
              ...
              <li className="flex items-center justify-center sm:justify-start gap-3 text-gray-400 text-sm md:text-base break-all">
